...
if ($search_term) {
  // Ricerca nei docenti - CORRETTO: usa Docente (singolare)
  $query_docenti = "
  ...
  // Ricerca nei corsi - CORRETTO: usa Corso (singolare)
  $query_corsi = "
  ...
  // Ricerca nelle edizioni - CORRETTO: usa Edizione (singolare)
  $query_edizioni = "
  ...
  // Ricerca nei partecipanti - CORRETTO: usa Partecipante (singolare)
  $query_partecipanti = "
